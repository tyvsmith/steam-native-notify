<!-- GENERATED by tools/gen-types-table.mjs on main. On this branch the
     generator and routes.ts are removed (clicks replay Steam's own handlers;
     frontend/replay.ts); the table stands as main's catalog for comparison. -->
